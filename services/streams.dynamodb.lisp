...
(common-lisp:defpackage #:aws-sdk-cl/services/streams.dynamodb
...
(common-lisp:in-package #:aws-sdk-cl/services/streams.dynamodb)
...
(common-lisp:progn
 (common-lisp:defstruct (list-streams-input (:copier common-lisp:nil))
   ...
   (limit-type common-lisp:nil :type
    (common-lisp:or positive-integer-object common-lisp:null))
   (exclusive-start-stream-arn-type common-lisp:nil :type
    (common-lisp:or stream-arn common-lisp:null)))
 (common-lisp:export
    ...
    (aws-sdk-cl/generator/shape::to-query-params "Limit"
                                                 (aws-sdk-cl/generator/shape:shape-to-params
                                                  (common-lisp:slot-value
                                                   aws-sdk-cl/generator/shape::shape
                                                   'limit)))
    (aws-sdk-cl/generator/shape::to-query-params "ExclusiveStartStreamArn"
                                                 (aws-sdk-cl/generator/shape:shape-to-params
                                                  (common-lisp:slot-value
                                                   aws-sdk-cl/generator/shape::shape
...
(common-lisp:progn
 (common-lisp:defstruct (list-streams-output (:copier common-lisp:nil))
   ...
   (last-evaluated-stream-arn-type common-lisp:nil :type
    (common-lisp:or stream-arn common-lisp:null)))
 (common-lisp:export
    ...
    (aws-sdk-cl/generator/shape::to-query-params "Streams"
                                                 (aws-sdk-cl/generator/shape:shape-to-params
                                                  (common-lisp:slot-value
                                                   aws-sdk-cl/generator/shape::shape
                                                   'streams)))
    (aws-sdk-cl/generator/shape::to-query-params "LastEvaluatedStreamArn"
                                                 (aws-sdk-cl/generator/shape:shape-to-params
                                                  (common-lisp:slot-value
                                                   aws-sdk-cl/generator/shape::shape
    ...
    (aws-sdk-cl/generator/shape::to-query-params "eventName"
                                                 (aws-sdk-cl/generator/shape:shape-to-params
                                                  (common-lisp:slot-value
                                                   aws-sdk-cl/generator/shape::shape
                                                   'event-name)))
    (aws-sdk-cl/generator/shape::to-query-params "eventVersion"
                                                 (aws-sdk-cl/generator/shape:shape-to-params
                                                  (common-lisp:slot-value
                                                   aws-sdk-cl/generator/shape::shape
                                                   'event-version)))
...
(common-lisp:progn
 (common-lisp:defstruct (shard (:copier common-lisp:nil))
   (shard-id-type common-lisp:nil :type
    (common-lisp:or shard-id common-lisp:null))
   (sequence-number-range-type common-lisp:nil :type
...
(common-lisp:progn
 (common-lisp:defstruct (stream (:copier common-lisp:nil))
   ...
   (table-name-type common-lisp:nil :type
    (common-lisp:or table-name common-lisp:null))
   (stream-label-type common-lisp:nil :type
    (common-lisp:or string common-lisp:null)))
    ...
    (aws-sdk-cl/generator/shape::to-query-params "TableName"
                                                 (aws-sdk-cl/generator/shape:shape-to-params
                                                  (common-lisp:slot-value
                                                   aws-sdk-cl/generator/shape::shape
                                                   'table-name)))
    (aws-sdk-cl/generator/shape::to-query-params "StreamLabel"
                                                 (aws-sdk-cl/generator/shape:shape-to-params
                                                  (common-lisp:slot-value
                                                   aws-sdk-cl/generator/shape::shape
                                                   'stream-label))))))
...
(common-lisp:progn
 (common-lisp:defstruct (stream-description (:copier common-lisp:nil))
   ...
   (stream-label-type common-lisp:nil :type
    (common-lisp:or string common-lisp:null))
   (stream-status-type common-lisp:nil :type
   ...
   (creation-request-date-time-type common-lisp:nil :type
   ...
   (last-evaluated-shard-id-type common-lisp:nil :type
    (common-lisp:or shard-id common-lisp:null)))
 (common-lisp:export
    ...
    (aws-sdk-cl/generator/shape::to-query-params "StreamViewType"
                                                 (aws-sdk-cl/generator/shape:shape-to-params
                                                  (common-lisp:slot-value
                                                   aws-sdk-cl/generator/shape::shape
                                                   'stream-view-type)))
    (aws-sdk-cl/generator/shape::to-query-params "CreationRequestDateTime"
                                                 (aws-sdk-cl/generator/shape:shape-to-params
                                                  (common-lisp:slot-value
                                                   aws-sdk-cl/generator/shape::shape
    ...
    (aws-sdk-cl/generator/shape::to-query-params "Shards"
                                                 (aws-sdk-cl/generator/shape:shape-to-params
                                                  (common-lisp:slot-value
                                                   aws-sdk-cl/generator/shape::shape
                                                   'shards)))
    (aws-sdk-cl/generator/shape::to-query-params "LastEvaluatedShardId"
                                                 (aws-sdk-cl/generator/shape:shape-to-params
                                                  (common-lisp:slot-value
                                                   aws-sdk-cl/generator/shape::shape
...
(common-lisp:progn
 (common-lisp:defstruct (stream-record (:copier common-lisp:nil))
   (approximate-creation-date-time-type common-lisp:nil :type
    (common-lisp:or date common-lisp:null))
   (keys-type common-lisp:nil :type
    (common-lisp:or attribute-map common-lisp:null))
   (new-image-type common-lisp:nil :type
    (common-lisp:or attribute-map common-lisp:null))
   (old-image-type common-lisp:nil :type
    (common-lisp:or attribute-map common-lisp:null))
   (sequence-number-type common-lisp:nil :type
    (common-lisp:or sequence-number common-lisp:null))
 ...
 (common-lisp:defmethod aws-sdk-cl/generator/shape:shape-to-params
                        ((aws-sdk-cl/generator/shape::shape stream-record))
   (common-lisp:append
    (aws-sdk-cl/generator/shape::to-query-params "ApproximateCreationDateTime"
                                                 (aws-sdk-cl/generator/shape:shape-to-params
                                                  (common-lisp:slot-value
                                                   aws-sdk-cl/generator/shape::shape
    ...
    (aws-sdk-cl/generator/shape::to-query-params "Keys"
                                                 (aws-sdk-cl/generator/shape:shape-to-params
                                                  (common-lisp:slot-value
                                                   aws-sdk-cl/generator/shape::shape
                                                   'keys)))
    (aws-sdk-cl/generator/shape::to-query-params "NewImage"
                                                 (aws-sdk-cl/generator/shape:shape-to-params
                                                  (common-lisp:slot-value
                                                   aws-sdk-cl/generator/shape::shape
                                                   'new-image)))
    (aws-sdk-cl/generator/shape::to-query-params "OldImage"
                                                 (aws-sdk-cl/generator/shape:shape-to-params
                                                  (common-lisp:slot-value
                                                   aws-sdk-cl/generator/shape::shape
                                                   'old-image)))
 ...
 (common-lisp:defun describe-stream
   ...
   (common-lisp:let ((aws-sdk-cl/generator/operation::input
     ...
     (aws-sdk-cl/generator/operation::parse-response
      (aws-sdk-cl/api:aws-request :service "streams.dynamodb" :method :post
                                  :params
                                  (common-lisp:append
