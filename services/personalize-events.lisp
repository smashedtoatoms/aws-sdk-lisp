...
(common-lisp:defpackage #:aws-sdk/services/personalize-events
  (:use)
  (:nicknames #:aws/personalize-events)
  (:import-from #:aws-sdk/generator/shape)
  (:import-from #:aws-sdk/generator/operation)
  (:import-from #:aws-sdk/api))
(common-lisp:in-package #:aws-sdk/services/personalize-events)
    ...
    (aws-sdk/generator/shape::to-query-params "eventType"
                                              (aws-sdk/generator/shape:shape-to-params
                                               (common-lisp:slot-value
                                                aws-sdk/generator/shape::shape
                                                'event-type)))
    (aws-sdk/generator/shape::to-query-params "eventValue"
                                              (aws-sdk/generator/shape:shape-to-params
                                               (common-lisp:slot-value
                                                aws-sdk/generator/shape::shape
                                                'event-value)))
    (aws-sdk/generator/shape::to-query-params "itemId"
                                              (aws-sdk/generator/shape:shape-to-params
                                               (common-lisp:slot-value
                                                aws-sdk/generator/shape::shape
                                                'item-id)))
    (aws-sdk/generator/shape::to-query-params "properties"
                                              (aws-sdk/generator/shape:shape-to-params
                                               (common-lisp:slot-value
                                                aws-sdk/generator/shape::shape
                                                'properties)))
    (aws-sdk/generator/shape::to-query-params "sentAt"
                                              (aws-sdk/generator/shape:shape-to-params
                                               (common-lisp:slot-value
                                                aws-sdk/generator/shape::shape
                                                'sent-at)))
    (aws-sdk/generator/shape::to-query-params "recommendationId"
                                              (aws-sdk/generator/shape:shape-to-params
                                               (common-lisp:slot-value
                                                aws-sdk/generator/shape::shape
                                                'recommendation-id)))
    (aws-sdk/generator/shape::to-query-params "impression"
                                              (aws-sdk/generator/shape:shape-to-params
                                               (common-lisp:slot-value
                                                aws-sdk/generator/shape::shape
                                                'impression))))))
...
(common-lisp:progn
 ...
 (common-lisp:defmethod aws-sdk/generator/shape:shape-to-params
                        ((aws-sdk/generator/shape::shape put-items-request))
   (common-lisp:append
...
(common-lisp:progn
 ...
 (common-lisp:defmethod aws-sdk/generator/shape:shape-to-params
                        ((aws-sdk/generator/shape::shape put-users-request))
   (common-lisp:append
    (aws-sdk/generator/shape::to-query-params "datasetArn"
                                              (aws-sdk/generator/shape:shape-to-params
                                               (common-lisp:slot-value
 ...
 (common-lisp:defun put-events
   ...
   (common-lisp:let ((aws-sdk/generator/operation::input
     ...
     (aws-sdk/generator/operation::parse-response
      (aws-sdk/api:aws-request :service "personalize-events" :method :post
                               :params
                               (common-lisp:append
                                `(("Action" ,@"PutEvents")
                                  ("Version" ,@"2018-03-22"))
