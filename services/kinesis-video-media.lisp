...
(common-lisp:defpackage #:aws-sdk/services/kinesis-video-media
  (:use)
  (:nicknames #:aws/kinesis-video-media)
  (:import-from #:aws-sdk/generator/shape)
  (:import-from #:aws-sdk/generator/operation)
  (:import-from #:aws-sdk/api))
(common-lisp:in-package #:aws-sdk/services/kinesis-video-media)
...
(common-lisp:progn
 ...
 (common-lisp:defmethod aws-sdk/generator/shape:shape-to-params
                        ((aws-sdk/generator/shape::shape get-media-input))
   (common-lisp:append
    ...
    (aws-sdk/generator/shape::to-query-params "StreamARN"
                                              (aws-sdk/generator/shape:shape-to-params
                                               (common-lisp:slot-value
                                                aws-sdk/generator/shape::shape
                                                'stream-arn)))
    (aws-sdk/generator/shape::to-query-params "StartSelector"
                                              (aws-sdk/generator/shape:shape-to-params
                                               (common-lisp:slot-value
                                                aws-sdk/generator/shape::shape
                                                'start-selector))))))
(common-lisp:progn
 ...
 (common-lisp:defmethod aws-sdk/generator/shape:shape-to-params
                        ((aws-sdk/generator/shape::shape get-media-output))
   (common-lisp:append
...
(common-lisp:progn
 ...
 (common-lisp:defmethod aws-sdk/generator/shape:shape-to-params
                        ((aws-sdk/generator/shape::shape start-selector))
   (common-lisp:append
    (aws-sdk/generator/shape::to-query-params "StartSelectorType"
                                              (aws-sdk/generator/shape:shape-to-params
                                               (common-lisp:slot-value
                                                aws-sdk/generator/shape::shape
                                                'start-selector-type)))
    (aws-sdk/generator/shape::to-query-params "AfterFragmentNumber"
                                              (aws-sdk/generator/shape:shape-to-params
                                               (common-lisp:slot-value
                                                aws-sdk/generator/shape::shape
 ...
 (common-lisp:defun get-media
   ...
   (common-lisp:let ((aws-sdk/generator/operation::input
     ...
     (aws-sdk/generator/operation::parse-response
      (aws-sdk/api:aws-request :service "kinesis-video-media" :method :post
                               :params
                               (common-lisp:append
                                `(("Action" ,@"GetMedia")
                                  ("Version" ,@"2017-09-30"))
