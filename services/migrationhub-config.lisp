...
(common-lisp:defpackage #:aws-sdk/services/migrationhub-config
  (:use)
  (:nicknames #:aws/migrationhub-config)
  (:import-from #:aws-sdk/generator/shape)
  (:import-from #:aws-sdk/generator/operation)
  (:import-from #:aws-sdk/api))
(common-lisp:in-package #:aws-sdk/services/migrationhub-config)
...
(common-lisp:progn
 ...
 (common-lisp:defmethod aws-sdk/generator/shape:shape-to-params
   ...
   (common-lisp:append
    (aws-sdk/generator/shape::to-query-params "HomeRegionControl"
                                              (aws-sdk/generator/shape:shape-to-params
                                               (common-lisp:slot-value
                                                aws-sdk/generator/shape::shape
                                                'home-region-control))))))
...
(common-lisp:progn
 ...
 (common-lisp:defmethod aws-sdk/generator/shape:shape-to-params
   ...
   (common-lisp:append
    (aws-sdk/generator/shape::to-query-params "HomeRegionControls"
                                              (aws-sdk/generator/shape:shape-to-params
                                               (common-lisp:slot-value
                                                aws-sdk/generator/shape::shape
...
(common-lisp:progn
 ...
 (common-lisp:defmethod aws-sdk/generator/shape:shape-to-params
                        ((aws-sdk/generator/shape::shape home-region-control))
   (common-lisp:append
    (aws-sdk/generator/shape::to-query-params "ControlId"
                                              (aws-sdk/generator/shape:shape-to-params
                                               (common-lisp:slot-value
    ...
    (aws-sdk/generator/shape::to-query-params "Target"
                                              (aws-sdk/generator/shape:shape-to-params
                                               (common-lisp:slot-value
                                                aws-sdk/generator/shape::shape
                                                'target)))
    (aws-sdk/generator/shape::to-query-params "RequestedTime"
                                              (aws-sdk/generator/shape:shape-to-params
                                               (common-lisp:slot-value
                                                aws-sdk/generator/shape::shape
                                                'requested-time))))))
 ...
 (common-lisp:defun create-home-region-control
   ...
   (common-lisp:let ((aws-sdk/generator/operation::input
     ...
     (aws-sdk/generator/operation::parse-response
      (aws-sdk/api:aws-request :service "migrationhub-config" :method :post
                               :params
                               (common-lisp:append
