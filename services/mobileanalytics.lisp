...
(common-lisp:defpackage #:aws-sdk-cl/services/mobileanalytics
...
(common-lisp:in-package #:aws-sdk-cl/services/mobileanalytics)
(common-lisp:progn
...
(common-lisp:progn
 (common-lisp:defstruct (put-events-input (:copier common-lisp:nil))
   ...
   (client-context-type (common-lisp:error ":clientcontext is required") :type
    (common-lisp:or string common-lisp:null))
   (client-context-encoding-type common-lisp:nil :type
    (common-lisp:or string common-lisp:null)))
 (common-lisp:export
  (common-lisp:list 'put-events-input 'make-put-events-input))
 (common-lisp:defmethod aws-sdk-cl/generator/shape:shape-to-params
                        ((aws-sdk-cl/generator/shape::shape put-events-input))
   (common-lisp:append
    ...
    (aws-sdk-cl/generator/shape::to-query-params "clientContext"
                                                 (aws-sdk-cl/generator/shape:shape-to-params
                                                  (common-lisp:slot-value
                                                   aws-sdk-cl/generator/shape::shape
                                                   'client-context)))
    (aws-sdk-cl/generator/shape::to-query-params "clientContextEncoding"
                                                 (aws-sdk-cl/generator/shape:shape-to-params
                                                  (common-lisp:slot-value
                                                   aws-sdk-cl/generator/shape::shape
 ...
 (common-lisp:defun put-events
   ...
   (common-lisp:let ((aws-sdk-cl/generator/operation::input
     ...
     (aws-sdk-cl/generator/operation::parse-response
      (aws-sdk-cl/api:aws-request :service "mobileanalytics" :method :post
                                  :params
                                  (common-lisp:append
                                   `(("Action" ,@"PutEvents")
                                     ("Version" ,@"2014-06-05"))
