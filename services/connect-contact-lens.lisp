...
(common-lisp:defpackage #:aws-sdk/services/connect-contact-lens
  (:use)
  (:nicknames #:aws/connect-contact-lens)
  (:import-from #:aws-sdk/generator/shape)
  (:import-from #:aws-sdk/generator/operation)
  (:import-from #:aws-sdk/api))
(common-lisp:in-package #:aws-sdk/services/connect-contact-lens)
(common-lisp:progn
 ...
 (common-lisp:defmethod aws-sdk/generator/shape:shape-to-params
                        ((aws-sdk/generator/shape::shape categories))
   (common-lisp:append
    (aws-sdk/generator/shape::to-query-params "MatchedCategories"
                                              (aws-sdk/generator/shape:shape-to-params
                                               (common-lisp:slot-value
                                                aws-sdk/generator/shape::shape
                                                'matched-categories)))
    (aws-sdk/generator/shape::to-query-params "MatchedDetails"
                                              (aws-sdk/generator/shape:shape-to-params
                                               (common-lisp:slot-value
                                                aws-sdk/generator/shape::shape
                                                'matched-details))))))
(common-lisp:progn
 ...
 (common-lisp:defmethod aws-sdk/generator/shape:shape-to-params
                        ((aws-sdk/generator/shape::shape category-details))
   (common-lisp:append
    (aws-sdk/generator/shape::to-query-params "PointsOfInterest"
                                              (aws-sdk/generator/shape:shape-to-params
                                               (common-lisp:slot-value
                                                aws-sdk/generator/shape::shape
                                                'points-of-interest))))))
...
(common-lisp:progn
 ...
 (common-lisp:defmethod aws-sdk/generator/shape:shape-to-params
                        ((aws-sdk/generator/shape::shape character-offsets))
   (common-lisp:append
    (aws-sdk/generator/shape::to-query-params "BeginOffsetChar"
                                              (aws-sdk/generator/shape:shape-to-params
                                               (common-lisp:slot-value
                                                aws-sdk/generator/shape::shape
                                                'begin-offset-char)))
    (aws-sdk/generator/shape::to-query-params "EndOffsetChar"
                                              (aws-sdk/generator/shape:shape-to-params
                                               (common-lisp:slot-value
                                                aws-sdk/generator/shape::shape
                                                'end-offset-char))))))
...
(common-lisp:progn
 ...
 (common-lisp:defmethod aws-sdk/generator/shape:shape-to-params
                        ((aws-sdk/generator/shape::shape issue-detected))
   (common-lisp:append
    (aws-sdk/generator/shape::to-query-params "CharacterOffsets"
                                              (aws-sdk/generator/shape:shape-to-params
                                               (common-lisp:slot-value
                                                aws-sdk/generator/shape::shape
                                                'character-offsets))))))
...
(common-lisp:progn
 ...
 (common-lisp:defmethod aws-sdk/generator/shape:shape-to-params
                        ((aws-sdk/generator/shape::shape point-of-interest))
   (common-lisp:append
    (aws-sdk/generator/shape::to-query-params "BeginOffsetMillis"
                                              (aws-sdk/generator/shape:shape-to-params
                                               (common-lisp:slot-value
                                                aws-sdk/generator/shape::shape
                                                'begin-offset-millis)))
    (aws-sdk/generator/shape::to-query-params "EndOffsetMillis"
                                              (aws-sdk/generator/shape:shape-to-params
                                               (common-lisp:slot-value
                                                aws-sdk/generator/shape::shape
                                                'end-offset-millis))))))
    ...
    (aws-sdk/generator/shape::to-query-params "Sentiment"
                                              (aws-sdk/generator/shape:shape-to-params
                                               (common-lisp:slot-value
                                                aws-sdk/generator/shape::shape
                                                'sentiment)))
    (aws-sdk/generator/shape::to-query-params "IssuesDetected"
                                              (aws-sdk/generator/shape:shape-to-params
                                               (common-lisp:slot-value
                                                aws-sdk/generator/shape::shape
                                                'issues-detected))))))
 ...
 (common-lisp:defun list-realtime-contact-analysis-segments
   ...
   (common-lisp:let ((aws-sdk/generator/operation::input
     ...
     (aws-sdk/generator/operation::parse-response
      (aws-sdk/api:aws-request :service "connect-contact-lens" :method :post
                               :params
                               (common-lisp:append
                                `(("Action"
