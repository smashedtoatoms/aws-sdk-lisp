...
(common-lisp:progn
 (common-lisp:defstruct (describe-group-request (:copier common-lisp:nil))
   (identity-store-id-type (common-lisp:error ":identity-store-id is required")
...
(common-lisp:progn
 (common-lisp:defstruct (filter (:copier common-lisp:nil))
   (attribute-path-type (common-lisp:error ":attribute-path is required") :type
    (common-lisp:or attribute-path common-lisp:null))
   (attribute-value-type (common-lisp:error ":attribute-value is required")
    :type (common-lisp:or sensitive-string-type common-lisp:null)))
