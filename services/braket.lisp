...
(common-lisp:progn
 (common-lisp:defstruct (cancel-quantum-task-request (:copier common-lisp:nil))
   ...
   (quantum-task-arn-type (common-lisp:error ":quantumtaskarn is required")
    :type (common-lisp:or quantum-task-arn common-lisp:null)))
 (common-lisp:export
...
(common-lisp:progn
 (common-lisp:defstruct
   ...
   (cancellation-status-type
    (common-lisp:error ":cancellationstatus is required") :type
...
(common-lisp:progn
 (common-lisp:defstruct (create-quantum-task-request (:copier common-lisp:nil))
   ...
   (device-parameters-type common-lisp:nil :type
    (common-lisp:or create-quantum-task-request-device-parameters-string
                    common-lisp:null))
   (output-s3bucket-type (common-lisp:error ":outputs3bucket is required")
    :type
    (common-lisp:or create-quantum-task-request-output-s3bucket-string
                    common-lisp:null))
   (output-s3key-prefix-type
    (common-lisp:error ":outputs3keyprefix is required") :type
    (common-lisp:or create-quantum-task-request-output-s3key-prefix-string
                    common-lisp:null))
   (shots-type (common-lisp:error ":shots is required") :type
...
(common-lisp:progn
 (common-lisp:defstruct (device-summary (:copier common-lisp:nil))
   ...
   (device-status-type (common-lisp:error ":devicestatus is required") :type
   ...
   (provider-name-type (common-lisp:error ":providername is required") :type
    (common-lisp:or string common-lisp:null)))
...
(common-lisp:progn
 (common-lisp:defstruct (get-device-response (:copier common-lisp:nil))
   ...
   (device-capabilities-type
    (common-lisp:error ":devicecapabilities is required") :type
    (common-lisp:or json-value common-lisp:null))
   (device-name-type (common-lisp:error ":devicename is required") :type
    (common-lisp:or string common-lisp:null))
   (device-status-type (common-lisp:error ":devicestatus is required") :type
...
(common-lisp:progn
 (common-lisp:defstruct (get-quantum-task-response (:copier common-lisp:nil))
   ...
   (device-arn-type (common-lisp:error ":devicearn is required") :type
    (common-lisp:or device-arn common-lisp:null))
   (device-parameters-type (common-lisp:error ":deviceparameters is required")
    :type (common-lisp:or json-value common-lisp:null))
   (ended-at-type common-lisp:nil :type
    (common-lisp:or synthetic-timestamp-date-time common-lisp:null))
   (failure-reason-type common-lisp:nil :type
    (common-lisp:or string common-lisp:null))
   (output-s3bucket-type (common-lisp:error ":outputs3bucket is required")
    :type (common-lisp:or string common-lisp:null))
   (output-s3directory-type
    (common-lisp:error ":outputs3directory is required") :type
    (common-lisp:or string common-lisp:null))
   (quantum-task-arn-type (common-lisp:error ":quantumtaskarn is required")
    :type (common-lisp:or quantum-task-arn common-lisp:null))
   (shots-type (common-lisp:error ":shots is required") :type
...
(common-lisp:progn
 (common-lisp:defstruct
   ...
   (next-token-type common-lisp:nil :type
    (common-lisp:or string common-lisp:null))
   (quantum-tasks-type (common-lisp:error ":quantumtasks is required") :type
