...
(common-lisp:defpackage #:aws-sdk-cl/services/elasticloadbalancing
...
(common-lisp:in-package #:aws-sdk-cl/services/elasticloadbalancing)
(common-lisp:progn
...
(common-lisp:progn
 (common-lisp:defstruct
   ...
   (load-balancer-name-type
    (common-lisp:error ":load-balancer-name is required") :type
...
(common-lisp:progn
 (common-lisp:defstruct (connection-settings (:copier common-lisp:nil))
   (idle-timeout-type (common-lisp:error ":idle-timeout is required") :type
...
(common-lisp:progn
 (common-lisp:defstruct
   ...
   (policy-name-type (common-lisp:error ":policy-name is required") :type
    (common-lisp:or policy-name common-lisp:null))
   (cookie-name-type (common-lisp:error ":cookie-name is required") :type
    (common-lisp:or cookie-name common-lisp:null)))
 (common-lisp:export
...
(common-lisp:progn
 (common-lisp:defstruct
   ...
   (policy-name-type (common-lisp:error ":policy-name is required") :type
    (common-lisp:or policy-name common-lisp:null))
   (policy-type-name-type (common-lisp:error ":policy-type-name is required")
    :type (common-lisp:or policy-type-name common-lisp:null))
   (policy-attributes-type common-lisp:nil :type
    ...
    (aws-sdk-cl/generator/shape::to-query-params "PolicyName"
                                                 (aws-sdk-cl/generator/shape:shape-to-params
                                                  (common-lisp:slot-value
                                                   aws-sdk-cl/generator/shape::shape
                                                   'policy-name)))
    (aws-sdk-cl/generator/shape::to-query-params "PolicyTypeName"
                                                 (aws-sdk-cl/generator/shape:shape-to-params
                                                  (common-lisp:slot-value
                                                   aws-sdk-cl/generator/shape::shape
                                                   'policy-type-name)))
    (aws-sdk-cl/generator/shape::to-query-params "PolicyAttributes"
                                                 (aws-sdk-cl/generator/shape:shape-to-params
                                                  (common-lisp:slot-value
                                                   aws-sdk-cl/generator/shape::shape
                                                   'policy-attributes))))))
...
(common-lisp:progn
 (common-lisp:defstruct
   ...
   (load-balancer-name-type
    (common-lisp:error ":load-balancer-name is required") :type
    (common-lisp:or access-point-name common-lisp:null))
   (load-balancer-ports-type
    (common-lisp:error ":load-balancer-ports is required") :type
    (common-lisp:or ports common-lisp:null)))
 (common-lisp:export
    ...
    (aws-sdk-cl/generator/shape::to-query-params "LoadBalancerName"
                                                 (aws-sdk-cl/generator/shape:shape-to-params
                                                  (common-lisp:slot-value
                                                   aws-sdk-cl/generator/shape::shape
                                                   'load-balancer-name)))
    (aws-sdk-cl/generator/shape::to-query-params "LoadBalancerPorts"
                                                 (aws-sdk-cl/generator/shape:shape-to-params
                                                  (common-lisp:slot-value
                                                   aws-sdk-cl/generator/shape::shape
                                                   'load-balancer-ports))))))
...
(common-lisp:progn
 (common-lisp:defstruct
   ...
   (load-balancer-descriptions-type common-lisp:nil :type
 ...
 (common-lisp:defmethod aws-sdk-cl/generator/shape:shape-to-params
   ...
   (common-lisp:append
    (aws-sdk-cl/generator/shape::to-query-params "LoadBalancerDescriptions"
                                                 (aws-sdk-cl/generator/shape:shape-to-params
                                                  (common-lisp:slot-value
                                                   aws-sdk-cl/generator/shape::shape
...
(common-lisp:progn
 (common-lisp:defstruct
   ...
   (policy-descriptions-type common-lisp:nil :type
 ...
 (common-lisp:defmethod aws-sdk-cl/generator/shape:shape-to-params
   ...
   (common-lisp:append
    (aws-sdk-cl/generator/shape::to-query-params "PolicyDescriptions"
                                                 (aws-sdk-cl/generator/shape:shape-to-params
                                                  (common-lisp:slot-value
                                                   aws-sdk-cl/generator/shape::shape
                                                   'policy-descriptions))))))
(common-lisp:progn
 (common-lisp:defstruct
   ...
   (policy-type-names-type common-lisp:nil :type
 ...
 (common-lisp:defmethod aws-sdk-cl/generator/shape:shape-to-params
   ...
   (common-lisp:append
    (aws-sdk-cl/generator/shape::to-query-params "PolicyTypeNames"
                                                 (aws-sdk-cl/generator/shape:shape-to-params
                                                  (common-lisp:slot-value
                                                   aws-sdk-cl/generator/shape::shape
                                                   'policy-type-names))))))
(common-lisp:progn
 (common-lisp:defstruct
   ...
   (policy-type-descriptions-type common-lisp:nil :type
 ...
 (common-lisp:defmethod aws-sdk-cl/generator/shape:shape-to-params
   ...
   (common-lisp:append
    (aws-sdk-cl/generator/shape::to-query-params "PolicyTypeDescriptions"
                                                 (aws-sdk-cl/generator/shape:shape-to-params
                                                  (common-lisp:slot-value
                                                   aws-sdk-cl/generator/shape::shape
...
(common-lisp:progn
 (common-lisp:defstruct (describe-tags-input (:copier common-lisp:nil))
   (load-balancer-names-type
    (common-lisp:error ":load-balancer-names is required") :type
    (common-lisp:or load-balancer-names-max20 common-lisp:null)))
 (common-lisp:export
...
(common-lisp:progn
 (common-lisp:defstruct (health-check (:copier common-lisp:nil))
   ...
   (unhealthy-threshold-type
    (common-lisp:error ":unhealthy-threshold is required") :type
    (common-lisp:or unhealthy-threshold common-lisp:null))
   (healthy-threshold-type (common-lisp:error ":healthy-threshold is required")
...
(common-lisp:progn
 (common-lisp:defstruct (instance-state (:copier common-lisp:nil))
   ...
   (reason-code-type common-lisp:nil :type
...
(common-lisp:progn
 (common-lisp:defstruct (listener (:copier common-lisp:nil))
   ...
   (load-balancer-port-type
    (common-lisp:error ":load-balancer-port is required") :type
    (common-lisp:or access-point-port common-lisp:null))
   (instance-protocol-type common-lisp:nil :type
    (common-lisp:or protocol common-lisp:null))
   (instance-port-type (common-lisp:error ":instance-port is required") :type
    (common-lisp:or instance-port common-lisp:null))
   (sslcertificate-id-type common-lisp:nil :type
...
(common-lisp:progn
 (common-lisp:defstruct (listener-description (:copier common-lisp:nil))
   (listener-type common-lisp:nil :type
    (common-lisp:or listener common-lisp:null))
   (policy-names-type common-lisp:nil :type
    (common-lisp:or policy-names common-lisp:null)))
 (common-lisp:export
...
(common-lisp:progn
 (common-lisp:defstruct (policies (:copier common-lisp:nil))
   ...
   (lbcookie-stickiness-policies-type common-lisp:nil :type
 ...
 (common-lisp:defmethod aws-sdk-cl/generator/shape:shape-to-params
                        ((aws-sdk-cl/generator/shape::shape policies))
   (common-lisp:append
...
(common-lisp:progn
 ...
 (common-lisp:defmethod aws-sdk-cl/generator/shape:shape-to-params
                        ((aws-sdk-cl/generator/shape::shape policy-attribute))
   (common-lisp:append
...
(common-lisp:progn
 (common-lisp:defstruct
   ...
   (cardinality-type common-lisp:nil :type
    ...
    (aws-sdk-cl/generator/shape::to-query-params "DefaultValue"
                                                 (aws-sdk-cl/generator/shape:shape-to-params
                                                  (common-lisp:slot-value
                                                   aws-sdk-cl/generator/shape::shape
                                                   'default-value)))
    (aws-sdk-cl/generator/shape::to-query-params "Cardinality"
                                                 (aws-sdk-cl/generator/shape:shape-to-params
                                                  (common-lisp:slot-value
                                                   aws-sdk-cl/generator/shape::shape
                                                   'cardinality))))))
...
(common-lisp:progn
 (common-lisp:defstruct (policy-description (:copier common-lisp:nil))
   (policy-name-type common-lisp:nil :type
    (common-lisp:or policy-name common-lisp:null))
   (policy-type-name-type common-lisp:nil :type
    (common-lisp:or policy-type-name common-lisp:null))
   (policy-attribute-descriptions-type common-lisp:nil :type
    ...
    (aws-sdk-cl/generator/shape::to-query-params "PolicyTypeName"
                                                 (aws-sdk-cl/generator/shape:shape-to-params
                                                  (common-lisp:slot-value
                                                   aws-sdk-cl/generator/shape::shape
                                                   'policy-type-name)))
    (aws-sdk-cl/generator/shape::to-query-params "PolicyAttributeDescriptions"
                                                 (aws-sdk-cl/generator/shape:shape-to-params
                                                  (common-lisp:slot-value
                                                   aws-sdk-cl/generator/shape::shape
...
(common-lisp:progn
 (common-lisp:defstruct (policy-type-description (:copier common-lisp:nil))
   ...
   (description-type common-lisp:nil :type
    (common-lisp:or description common-lisp:null))
   (policy-attribute-type-descriptions-type common-lisp:nil :type
...
(common-lisp:progn
 (common-lisp:defstruct
   ...
   (load-balancer-port-type
    (common-lisp:error ":load-balancer-port is required") :type
    (common-lisp:or access-point-port common-lisp:null))
   (sslcertificate-id-type (common-lisp:error ":sslcertificate-id is required")
...
(common-lisp:progn
 ...
 (common-lisp:defmethod aws-sdk-cl/generator/shape:shape-to-params
                        ((aws-sdk-cl/generator/shape::shape tag-key-only))
   (common-lisp:append
    (aws-sdk-cl/generator/shape::to-query-params "Key"
                                                 (aws-sdk-cl/generator/shape:shape-to-params
                                                  (common-lisp:slot-value
 ...
 (common-lisp:defun add-tags
   ...
   (common-lisp:let ((aws-sdk-cl/generator/operation::input
     ...
     (aws-sdk-cl/generator/operation::parse-response
      (aws-sdk-cl/api:aws-request :service "elasticloadbalancing" :method :post
                                  :params
                                  (common-lisp:append
                                   `(("Action" ,@"AddTags")
                                     ("Version" ,@"2012-06-01"))
