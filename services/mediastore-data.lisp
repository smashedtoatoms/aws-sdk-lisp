...
(common-lisp:defpackage #:aws-sdk/services/mediastore-data
  (:use)
  (:nicknames #:aws/mediastore-data)
  (:import-from #:aws-sdk/generator/shape)
  (:import-from #:aws-sdk/generator/operation)
  (:import-from #:aws-sdk/api))
(common-lisp:in-package #:aws-sdk/services/mediastore-data)
...
(common-lisp:progn
 ...
 (common-lisp:defmethod aws-sdk/generator/shape:shape-to-params
                        ((aws-sdk/generator/shape::shape get-object-response))
   (common-lisp:append
...
(common-lisp:progn
 ...
 (common-lisp:defmethod aws-sdk/generator/shape:shape-to-params
                        ((aws-sdk/generator/shape::shape list-items-request))
   (common-lisp:append
    (aws-sdk/generator/shape::to-query-params "Path"
                                              (aws-sdk/generator/shape:shape-to-params
                                               (common-lisp:slot-value
...
(common-lisp:progn
 ...
 (common-lisp:defmethod aws-sdk/generator/shape:shape-to-params
                        ((aws-sdk/generator/shape::shape list-items-response))
   (common-lisp:append
    ...
    (aws-sdk/generator/shape::to-query-params "StorageClass"
                                              (aws-sdk/generator/shape:shape-to-params
                                               (common-lisp:slot-value
                                                aws-sdk/generator/shape::shape
                                                'storage-class)))
    (aws-sdk/generator/shape::to-query-params "UploadAvailability"
                                              (aws-sdk/generator/shape:shape-to-params
                                               (common-lisp:slot-value
                                                aws-sdk/generator/shape::shape
                                                'upload-availability))))))
(common-lisp:progn
 ...
 (common-lisp:defmethod aws-sdk/generator/shape:shape-to-params
                        ((aws-sdk/generator/shape::shape put-object-response))
   (common-lisp:append
    (aws-sdk/generator/shape::to-query-params "ContentSHA256"
                                              (aws-sdk/generator/shape:shape-to-params
                                               (common-lisp:slot-value
                                                aws-sdk/generator/shape::shape
                                                'content-sha256)))
 ...
 (common-lisp:defun delete-object
   ...
   (common-lisp:let ((aws-sdk/generator/operation::input
     ...
     (aws-sdk/generator/operation::parse-response
      (aws-sdk/api:aws-request :service "mediastore-data" :method :delete
                               :params
                               (common-lisp:append
                                `(("Action" ,@"DeleteObject")
                                  ("Version" ,@"2017-09-01"))
 ...
 (common-lisp:defun describe-object
   ...
   (common-lisp:let ((aws-sdk/generator/operation::input
                      (common-lisp:apply 'make-describe-object-request
                                         aws-sdk/generator/operation::args)))
     (aws-sdk/generator/operation::parse-response
      (aws-sdk/api:aws-request :service "mediastore-data" :method :head :params
                               (common-lisp:append
 ...
 (common-lisp:defun get-object
   ...
   (common-lisp:let ((aws-sdk/generator/operation::input
                      (common-lisp:apply 'make-get-object-request
                                         aws-sdk/generator/operation::args)))
     (aws-sdk/generator/operation::parse-response
      (aws-sdk/api:aws-request :service "mediastore-data" :method :get :params
                               (common-lisp:append
                                `(("Action" ,@"GetObject")
                                  ("Version" ,@"2017-09-01"))
                                (aws-sdk/generator/shape:shape-to-params
 ...
 (common-lisp:defun put-object
   ...
   (common-lisp:let ((aws-sdk/generator/operation::input
                      (common-lisp:apply 'make-put-object-request
                                         aws-sdk/generator/operation::args)))
     (aws-sdk/generator/operation::parse-response
      (aws-sdk/api:aws-request :service "mediastore-data" :method :put :params
                               (common-lisp:append
                                `(("Action" ,@"PutObject")
                                  ("Version" ,@"2017-09-01"))
                                (aws-sdk/generator/shape:shape-to-params
