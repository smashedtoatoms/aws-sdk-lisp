...
(common-lisp:progn
 (common-lisp:defstruct
   ...
   (memberships-type common-lisp:nil :type
...
(common-lisp:progn
 (common-lisp:defstruct
   ...
   (environment-ids-type (common-lisp:error ":environmentids is required")
    :type (common-lisp:or bounded-environment-id-list common-lisp:null)))
 (common-lisp:export
