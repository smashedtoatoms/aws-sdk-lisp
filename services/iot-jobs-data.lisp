...
(common-lisp:defpackage #:aws-sdk/services/iot-jobs-data
  (:use)
  (:nicknames #:aws/iot-jobs-data)
  (:import-from #:aws-sdk/generator/shape)
  (:import-from #:aws-sdk/generator/operation)
  (:import-from #:aws-sdk/api))
(common-lisp:in-package #:aws-sdk/services/iot-jobs-data)
    ...
    (aws-sdk/generator/shape::to-query-params "thingName"
                                              (aws-sdk/generator/shape:shape-to-params
                                               (common-lisp:slot-value
                                                aws-sdk/generator/shape::shape
                                                'thing-name)))
    (aws-sdk/generator/shape::to-query-params "includeJobDocument"
                                              (aws-sdk/generator/shape:shape-to-params
                                               (common-lisp:slot-value
                                                aws-sdk/generator/shape::shape
                                                'include-job-document)))
    (aws-sdk/generator/shape::to-query-params "executionNumber"
                                              (aws-sdk/generator/shape:shape-to-params
                                               (common-lisp:slot-value
                                                aws-sdk/generator/shape::shape
                                                'execution-number))))))
...
(common-lisp:progn
 ...
 (common-lisp:defmethod aws-sdk/generator/shape:shape-to-params
   ...
   (common-lisp:append
    (aws-sdk/generator/shape::to-query-params "inProgressJobs"
                                              (aws-sdk/generator/shape:shape-to-params
                                               (common-lisp:slot-value
                                                aws-sdk/generator/shape::shape
                                                'in-progress-jobs)))
    (aws-sdk/generator/shape::to-query-params "queuedJobs"
                                              (aws-sdk/generator/shape:shape-to-params
                                               (common-lisp:slot-value
                                                aws-sdk/generator/shape::shape
                                                'queued-jobs))))))
...
(common-lisp:progn
 ...
 (common-lisp:defmethod aws-sdk/generator/shape:shape-to-params
                        ((aws-sdk/generator/shape::shape job-execution))
   (common-lisp:append
    (aws-sdk/generator/shape::to-query-params "jobId"
                                              (aws-sdk/generator/shape:shape-to-params
                                               (common-lisp:slot-value
    ...
    (aws-sdk/generator/shape::to-query-params "statusDetails"
                                              (aws-sdk/generator/shape:shape-to-params
                                               (common-lisp:slot-value
                                                aws-sdk/generator/shape::shape
                                                'status-details)))
    (aws-sdk/generator/shape::to-query-params "queuedAt"
                                              (aws-sdk/generator/shape:shape-to-params
                                               (common-lisp:slot-value
                                                aws-sdk/generator/shape::shape
                                                'queued-at)))
    ...
    (aws-sdk/generator/shape::to-query-params "executionNumber"
                                              (aws-sdk/generator/shape:shape-to-params
                                               (common-lisp:slot-value
                                                aws-sdk/generator/shape::shape
                                                'execution-number)))
    (aws-sdk/generator/shape::to-query-params "jobDocument"
                                              (aws-sdk/generator/shape:shape-to-params
                                               (common-lisp:slot-value
                                                aws-sdk/generator/shape::shape
                                                'job-document))))))
(common-lisp:progn
 ...
 (common-lisp:defmethod aws-sdk/generator/shape:shape-to-params
                        ((aws-sdk/generator/shape::shape job-execution-state))
   (common-lisp:append
    (aws-sdk/generator/shape::to-query-params "status"
                                              (aws-sdk/generator/shape:shape-to-params
                                               (common-lisp:slot-value
    ...
    (aws-sdk/generator/shape::to-query-params "statusDetails"
                                              (aws-sdk/generator/shape:shape-to-params
                                               (common-lisp:slot-value
                                                aws-sdk/generator/shape::shape
                                                'status-details)))
    (aws-sdk/generator/shape::to-query-params "stepTimeoutInMinutes"
                                              (aws-sdk/generator/shape:shape-to-params
                                               (common-lisp:slot-value
                                                aws-sdk/generator/shape::shape
    ...
    (aws-sdk/generator/shape::to-query-params "expectedVersion"
                                              (aws-sdk/generator/shape:shape-to-params
                                               (common-lisp:slot-value
                                                aws-sdk/generator/shape::shape
                                                'expected-version)))
    (aws-sdk/generator/shape::to-query-params "includeJobExecutionState"
                                              (aws-sdk/generator/shape:shape-to-params
                                               (common-lisp:slot-value
                                                aws-sdk/generator/shape::shape
...
(common-lisp:progn
 ...
 (common-lisp:defmethod aws-sdk/generator/shape:shape-to-params
   ...
   (common-lisp:append
    (aws-sdk/generator/shape::to-query-params "executionState"
                                              (aws-sdk/generator/shape:shape-to-params
                                               (common-lisp:slot-value
                                                aws-sdk/generator/shape::shape
                                                'execution-state)))
 ...
 (common-lisp:defun describe-job-execution
   ...
   (common-lisp:let ((aws-sdk/generator/operation::input
     ...
     (aws-sdk/generator/operation::parse-response
      (aws-sdk/api:aws-request :service "iot-jobs-data" :method :get :params
                               (common-lisp:append
 ...
 (common-lisp:defun start-next-pending-job-execution
   ...
   (common-lisp:let ((aws-sdk/generator/operation::input
                      (common-lisp:apply
                       ...
                       aws-sdk/generator/operation::args)))
     (aws-sdk/generator/operation::parse-response
      (aws-sdk/api:aws-request :service "iot-jobs-data" :method :put :params
                               (common-lisp:append
 ...
 (common-lisp:defun update-job-execution
   ...
   (common-lisp:let ((aws-sdk/generator/operation::input
                      (common-lisp:apply 'make-update-job-execution-request
                                         aws-sdk/generator/operation::args)))
     (aws-sdk/generator/operation::parse-response
      (aws-sdk/api:aws-request :service "iot-jobs-data" :method :post :params
                               (common-lisp:append
