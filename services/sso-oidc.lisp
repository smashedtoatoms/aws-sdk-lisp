...
(common-lisp:defpackage #:aws-sdk/services/sso-oidc
  (:use)
  (:nicknames #:aws/sso-oidc)
  (:import-from #:aws-sdk/generator/shape)
  (:import-from #:aws-sdk/generator/operation)
  (:import-from #:aws-sdk/api))
(common-lisp:in-package #:aws-sdk/services/sso-oidc)
    ...
    (aws-sdk/generator/shape::to-query-params "clientSecret"
                                              (aws-sdk/generator/shape:shape-to-params
                                               (common-lisp:slot-value
                                                aws-sdk/generator/shape::shape
                                                'client-secret)))
    (aws-sdk/generator/shape::to-query-params "grantType"
                                              (aws-sdk/generator/shape:shape-to-params
                                               (common-lisp:slot-value
                                                aws-sdk/generator/shape::shape
                                                'grant-type)))
    (aws-sdk/generator/shape::to-query-params "deviceCode"
                                              (aws-sdk/generator/shape:shape-to-params
                                               (common-lisp:slot-value
                                                aws-sdk/generator/shape::shape
                                                'device-code)))
    ...
    (aws-sdk/generator/shape::to-query-params "clientName"
                                              (aws-sdk/generator/shape:shape-to-params
                                               (common-lisp:slot-value
                                                aws-sdk/generator/shape::shape
                                                'client-name)))
    (aws-sdk/generator/shape::to-query-params "clientType"
                                              (aws-sdk/generator/shape:shape-to-params
                                               (common-lisp:slot-value
                                                aws-sdk/generator/shape::shape
                                                'client-type)))
    ...
    (aws-sdk/generator/shape::to-query-params "clientSecret"
                                              (aws-sdk/generator/shape:shape-to-params
                                               (common-lisp:slot-value
                                                aws-sdk/generator/shape::shape
                                                'client-secret)))
    (aws-sdk/generator/shape::to-query-params "clientIdIssuedAt"
                                              (aws-sdk/generator/shape:shape-to-params
                                               (common-lisp:slot-value
                                                aws-sdk/generator/shape::shape
                                                'client-id-issued-at)))
    (aws-sdk/generator/shape::to-query-params "clientSecretExpiresAt"
                                              (aws-sdk/generator/shape:shape-to-params
                                               (common-lisp:slot-value
                                                aws-sdk/generator/shape::shape
    ...
    (aws-sdk/generator/shape::to-query-params "userCode"
                                              (aws-sdk/generator/shape:shape-to-params
                                               (common-lisp:slot-value
                                                aws-sdk/generator/shape::shape
                                                'user-code)))
    (aws-sdk/generator/shape::to-query-params "verificationUri"
                                              (aws-sdk/generator/shape:shape-to-params
                                               (common-lisp:slot-value
                                                aws-sdk/generator/shape::shape
                                                'verification-uri)))
    (aws-sdk/generator/shape::to-query-params "verificationUriComplete"
                                              (aws-sdk/generator/shape:shape-to-params
                                               (common-lisp:slot-value
                                                aws-sdk/generator/shape::shape
 ...
 (common-lisp:defun create-token
   ...
   (common-lisp:let ((aws-sdk/generator/operation::input
     ...
     (aws-sdk/generator/operation::parse-response
      (aws-sdk/api:aws-request :service "sso-oidc" :method :post :params
                               (common-lisp:append
                                `(("Action" ,@"CreateToken")
                                  ("Version" ,@"2019-06-10"))
                                (aws-sdk/generator/shape:shape-to-params
