...
(common-lisp:defpackage #:aws-sdk/services/qldb-session
  (:use)
  (:nicknames #:aws/qldb-session)
  (:import-from #:aws-sdk/generator/shape)
  (:import-from #:aws-sdk/generator/operation)
  (:import-from #:aws-sdk/api))
(common-lisp:in-package #:aws-sdk/services/qldb-session)
(common-lisp:progn
...
(common-lisp:progn
 ...
 (common-lisp:defmethod aws-sdk/generator/shape:shape-to-params
   ...
   (common-lisp:append
    (aws-sdk/generator/shape::to-query-params "TimingInformation"
    ...
    (aws-sdk/generator/shape::to-query-params "TransactionId"
                                              (aws-sdk/generator/shape:shape-to-params
                                               (common-lisp:slot-value
                                                aws-sdk/generator/shape::shape
                                                'transaction-id)))
    (aws-sdk/generator/shape::to-query-params "CommitDigest"
                                              (aws-sdk/generator/shape:shape-to-params
                                               (common-lisp:slot-value
                                                aws-sdk/generator/shape::shape
                                                'commit-digest))))))
    ...
    (aws-sdk/generator/shape::to-query-params "TimingInformation"
                                              (aws-sdk/generator/shape:shape-to-params
                                               (common-lisp:slot-value
                                                aws-sdk/generator/shape::shape
                                                'timing-information)))
    (aws-sdk/generator/shape::to-query-params "ConsumedIOs"
                                              (aws-sdk/generator/shape:shape-to-params
                                               (common-lisp:slot-value
                                                aws-sdk/generator/shape::shape
                                                'consumed-ios))))))
(common-lisp:progn
 ...
 (common-lisp:defmethod aws-sdk/generator/shape:shape-to-params
                        ((aws-sdk/generator/shape::shape end-session-request))
   (common-lisp:append)))
(common-lisp:progn
 ...
 (common-lisp:defmethod aws-sdk/generator/shape:shape-to-params
                        ((aws-sdk/generator/shape::shape end-session-result))
   (common-lisp:append
    (aws-sdk/generator/shape::to-query-params "TimingInformation"
                                              (aws-sdk/generator/shape:shape-to-params
                                               (common-lisp:slot-value
...
(common-lisp:progn
 ...
 (common-lisp:defmethod aws-sdk/generator/shape:shape-to-params
   ...
   (common-lisp:append
    (aws-sdk/generator/shape::to-query-params "FirstPage"
                                              (aws-sdk/generator/shape:shape-to-params
                                               (common-lisp:slot-value
                                                aws-sdk/generator/shape::shape
                                                'first-page)))
...
(common-lisp:progn
 ...
 (common-lisp:defmethod aws-sdk/generator/shape:shape-to-params
                        ((aws-sdk/generator/shape::shape fetch-page-request))
   (common-lisp:append
    (aws-sdk/generator/shape::to-query-params "TransactionId"
                                              (aws-sdk/generator/shape:shape-to-params
                                               (common-lisp:slot-value
...
(common-lisp:progn
 ...
 (common-lisp:defmethod aws-sdk/generator/shape:shape-to-params
                        ((aws-sdk/generator/shape::shape fetch-page-result))
   (common-lisp:append
...
(common-lisp:progn
 ...
 (common-lisp:defmethod aws-sdk/generator/shape:shape-to-params
                        ((aws-sdk/generator/shape::shape iousage))
   (common-lisp:append
    (aws-sdk/generator/shape::to-query-params "ReadIOs"
                                              (aws-sdk/generator/shape:shape-to-params
                                               (common-lisp:slot-value
                                                aws-sdk/generator/shape::shape
                                                'read-ios)))
    (aws-sdk/generator/shape::to-query-params "WriteIOs"
                                              (aws-sdk/generator/shape:shape-to-params
                                               (common-lisp:slot-value
                                                aws-sdk/generator/shape::shape
                                                'write-ios))))))
    ...
    (aws-sdk/generator/shape::to-query-params "SessionToken"
                                              (aws-sdk/generator/shape:shape-to-params
                                               (common-lisp:slot-value
                                                aws-sdk/generator/shape::shape
                                                'session-token)))
    (aws-sdk/generator/shape::to-query-params "StartSession"
                                              (aws-sdk/generator/shape:shape-to-params
                                               (common-lisp:slot-value
                                                aws-sdk/generator/shape::shape
                                                'start-session)))
    (aws-sdk/generator/shape::to-query-params "StartTransaction"
                                              (aws-sdk/generator/shape:shape-to-params
                                               (common-lisp:slot-value
                                                aws-sdk/generator/shape::shape
                                                'start-transaction)))
    (aws-sdk/generator/shape::to-query-params "EndSession"
                                              (aws-sdk/generator/shape:shape-to-params
                                               (common-lisp:slot-value
                                                aws-sdk/generator/shape::shape
                                                'end-session)))
    (aws-sdk/generator/shape::to-query-params "CommitTransaction"
                                              (aws-sdk/generator/shape:shape-to-params
                                               (common-lisp:slot-value
                                                aws-sdk/generator/shape::shape
                                                'commit-transaction)))
    (aws-sdk/generator/shape::to-query-params "AbortTransaction"
                                              (aws-sdk/generator/shape:shape-to-params
                                               (common-lisp:slot-value
                                                aws-sdk/generator/shape::shape
                                                'abort-transaction)))
    (aws-sdk/generator/shape::to-query-params "ExecuteStatement"
                                              (aws-sdk/generator/shape:shape-to-params
                                               (common-lisp:slot-value
                                                aws-sdk/generator/shape::shape
                                                'execute-statement)))
    (aws-sdk/generator/shape::to-query-params "FetchPage"
                                              (aws-sdk/generator/shape:shape-to-params
                                               (common-lisp:slot-value
                                                aws-sdk/generator/shape::shape
                                                'fetch-page))))))
...
(common-lisp:progn
 ...
 (common-lisp:defmethod aws-sdk/generator/shape:shape-to-params
                        ((aws-sdk/generator/shape::shape start-session-result))
   (common-lisp:append
    (aws-sdk/generator/shape::to-query-params "SessionToken"
                                              (aws-sdk/generator/shape:shape-to-params
                                               (common-lisp:slot-value
...
(common-lisp:progn
 ...
 (common-lisp:defmethod aws-sdk/generator/shape:shape-to-params
                        ((aws-sdk/generator/shape::shape timing-information))
   (common-lisp:append
    (aws-sdk/generator/shape::to-query-params "ProcessingTimeMilliseconds"
                                              (aws-sdk/generator/shape:shape-to-params
                                               (common-lisp:slot-value
                                                aws-sdk/generator/shape::shape
...
(common-lisp:progn
 ...
 (common-lisp:defmethod aws-sdk/generator/shape:shape-to-params
   ...
   (common-lisp:append
    (aws-sdk/generator/shape::to-query-params "IonBinary"
                                              (aws-sdk/generator/shape:shape-to-params
                                               (common-lisp:slot-value
                                                aws-sdk/generator/shape::shape
                                                'ion-binary)))
 ...
 (common-lisp:defun send-command
   ...
   (common-lisp:let ((aws-sdk/generator/operation::input
     ...
     (aws-sdk/generator/operation::parse-response
      (aws-sdk/api:aws-request :service "qldb-session" :method :post :params
                               (common-lisp:append
                                `(("Action" ,@"SendCommand")
                                  ("Version" ,@"2019-07-11"))
                                (aws-sdk/generator/shape:shape-to-params
