...
(common-lisp:defpackage #:aws-sdk/services/kinesis-video-signaling
  (:use)
  (:nicknames #:aws/kinesis-video-signaling)
  (:import-from #:aws-sdk/generator/shape)
  (:import-from #:aws-sdk/generator/operation)
  (:import-from #:aws-sdk/api))
(common-lisp:in-package #:aws-sdk/services/kinesis-video-signaling)
...
(common-lisp:progn
 ...
 (common-lisp:defmethod aws-sdk/generator/shape:shape-to-params
   ...
   (common-lisp:append
    (aws-sdk/generator/shape::to-query-params "IceServerList"
                                              (aws-sdk/generator/shape:shape-to-params
                                               (common-lisp:slot-value
                                                aws-sdk/generator/shape::shape
                                                'ice-server-list))))))
(common-lisp:progn
 ...
 (common-lisp:defmethod aws-sdk/generator/shape:shape-to-params
                        ((aws-sdk/generator/shape::shape ice-server))
   (common-lisp:append
    ...
    (aws-sdk/generator/shape::to-query-params "ChannelARN"
                                              (aws-sdk/generator/shape:shape-to-params
                                               (common-lisp:slot-value
                                                aws-sdk/generator/shape::shape
                                                'channel-arn)))
    (aws-sdk/generator/shape::to-query-params "SenderClientId"
                                              (aws-sdk/generator/shape:shape-to-params
                                               (common-lisp:slot-value
                                                aws-sdk/generator/shape::shape
                                                'sender-client-id)))
    (aws-sdk/generator/shape::to-query-params "MessagePayload"
                                              (aws-sdk/generator/shape:shape-to-params
                                               (common-lisp:slot-value
                                                aws-sdk/generator/shape::shape
                                                'message-payload))))))
 ...
 (common-lisp:defun get-ice-server-config
   ...
   (common-lisp:let ((aws-sdk/generator/operation::input
     ...
     (aws-sdk/generator/operation::parse-response
      (aws-sdk/api:aws-request :service "kinesis-video-signaling" :method :post
                               :params
                               (common-lisp:append
