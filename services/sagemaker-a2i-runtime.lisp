...
(common-lisp:defpackage #:aws-sdk/services/sagemaker-a2i-runtime
  (:use)
  (:nicknames #:aws/sagemaker-a2i-runtime)
  (:import-from #:aws-sdk/generator/shape)
  (:import-from #:aws-sdk/generator/operation)
  (:import-from #:aws-sdk/api))
(common-lisp:in-package #:aws-sdk/services/sagemaker-a2i-runtime)
    ...
    (aws-sdk/generator/shape::to-query-params "FailureCode"
                                              (aws-sdk/generator/shape:shape-to-params
                                               (common-lisp:slot-value
                                                aws-sdk/generator/shape::shape
                                                'failure-code)))
    (aws-sdk/generator/shape::to-query-params "HumanLoopStatus"
                                              (aws-sdk/generator/shape:shape-to-params
                                               (common-lisp:slot-value
                                                aws-sdk/generator/shape::shape
                                                'human-loop-status)))
    ...
    (aws-sdk/generator/shape::to-query-params "FlowDefinitionArn"
                                              (aws-sdk/generator/shape:shape-to-params
                                               (common-lisp:slot-value
                                                aws-sdk/generator/shape::shape
                                                'flow-definition-arn)))
    (aws-sdk/generator/shape::to-query-params "HumanLoopOutput"
                                              (aws-sdk/generator/shape:shape-to-params
                                               (common-lisp:slot-value
                                                aws-sdk/generator/shape::shape
                                                'human-loop-output))))))
...
(common-lisp:progn
 ...
 (common-lisp:defmethod aws-sdk/generator/shape:shape-to-params
                        ((aws-sdk/generator/shape::shape human-loop-input))
   (common-lisp:append
    (aws-sdk/generator/shape::to-query-params "InputContent"
                                              (aws-sdk/generator/shape:shape-to-params
                                               (common-lisp:slot-value
                                                aws-sdk/generator/shape::shape
                                                'input-content))))))
...
(common-lisp:progn
 ...
 (common-lisp:defmethod aws-sdk/generator/shape:shape-to-params
                        ((aws-sdk/generator/shape::shape human-loop-output))
   (common-lisp:append
    (aws-sdk/generator/shape::to-query-params "OutputS3Uri"
                                              (aws-sdk/generator/shape:shape-to-params
                                               (common-lisp:slot-value
                                                aws-sdk/generator/shape::shape
                                                'output-s3uri))))))
...
(common-lisp:progn
 ...
 (common-lisp:defmethod aws-sdk/generator/shape:shape-to-params
                        ((aws-sdk/generator/shape::shape human-loop-summary))
   (common-lisp:append
    (aws-sdk/generator/shape::to-query-params "HumanLoopName"
                                              (aws-sdk/generator/shape:shape-to-params
                                               (common-lisp:slot-value
...
(common-lisp:progn
 ...
 (common-lisp:defmethod aws-sdk/generator/shape:shape-to-params
   ...
   (common-lisp:append
    (aws-sdk/generator/shape::to-query-params "HumanLoopSummaries"
                                              (aws-sdk/generator/shape:shape-to-params
                                               (common-lisp:slot-value
                                                aws-sdk/generator/shape::shape
                                                'human-loop-summaries)))
    ...
    (aws-sdk/generator/shape::to-query-params "FlowDefinitionArn"
                                              (aws-sdk/generator/shape:shape-to-params
                                               (common-lisp:slot-value
                                                aws-sdk/generator/shape::shape
                                                'flow-definition-arn)))
    (aws-sdk/generator/shape::to-query-params "HumanLoopInput"
                                              (aws-sdk/generator/shape:shape-to-params
                                               (common-lisp:slot-value
                                                aws-sdk/generator/shape::shape
                                                'human-loop-input)))
 ...
 (common-lisp:defun delete-human-loop
   ...
   (common-lisp:let ((aws-sdk/generator/operation::input
     ...
     (aws-sdk/generator/operation::parse-response
      (aws-sdk/api:aws-request :service "sagemaker-a2i-runtime" :method :delete
                               :params
                               (common-lisp:append
 ...
 (common-lisp:defun describe-human-loop
   ...
   (common-lisp:let ((aws-sdk/generator/operation::input
                      (common-lisp:apply 'make-describe-human-loop-request
                                         aws-sdk/generator/operation::args)))
     (aws-sdk/generator/operation::parse-response
      (aws-sdk/api:aws-request :service "sagemaker-a2i-runtime" :method :get
                               :params
                               (common-lisp:append
 ...
 (common-lisp:defun start-human-loop
   ...
   (common-lisp:let ((aws-sdk/generator/operation::input
                      (common-lisp:apply 'make-start-human-loop-request
                                         aws-sdk/generator/operation::args)))
     (aws-sdk/generator/operation::parse-response
      (aws-sdk/api:aws-request :service "sagemaker-a2i-runtime" :method :post
                               :params
                               (common-lisp:append
