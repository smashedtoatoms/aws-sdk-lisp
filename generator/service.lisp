...
(defpackage #:aws-sdk-cl/generator/service/dump)

(defun dump-service-to-stream (service json &optional (stream *standard-output*))
  (let ((*package* (find-package :aws-sdk-cl/generator/service/dump))
        (*print-case* :downcase)
        (package-name (make-symbol (format nil "~:@(~A/~A/~A~)" :aws-sdk-cl :services service))))
    (format stream "~&;; DO NOT EDIT: File is generated by aws-sdk-cl/GENERATOR.~2%")
    (format stream "~&~S~%"
...
(defun generate-service (service)
  (let* ((output-dir (asdf:system-relative-pathname :aws-sdk-cl #P"services/"))
         (output (make-pathname :defaults output-dir
                                :name service
                                :type "lisp"))
         (service-dir (uiop:ensure-directory-pathname
                       (merge-pathnames service
                                        (asdf:system-relative-pathname :aws-sdk-cl #P"specs/apis/"))))
         (api-2.json (merge-pathnames #P"api-2.json"
...
(defun generate-all-services (&key silent)
  (dolist (service-dir
           (uiop:subdirectories (asdf:system-relative-pathname :aws-sdk-cl #P"specs/apis/")))
